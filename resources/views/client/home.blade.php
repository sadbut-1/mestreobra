...
@section('content')
        <div class="row">
            ...
            <div class="panel panel-default">
                <div class="panel-body" >
                    <div class="row">
                        <div class="col-sm-10">
                            <small><b>Seus pedidos recentes</b>&nbsp;&nbsp;&nbsp;&nbsp;<a href="{{ url('/client/historico') }}" class="text-info">Ver pedidos antigos</a></small>
                        </div>
                        @if (count($pedidos) > 0)
                            <div class="col-sm-2">
                    ...
                    <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <strong>Interessados: </strong>
                                            @if(count($pedido->interessados) >0)
                                                ...
                                                @endforeach
                                            @else
                                                <i>Nenhum interessado até o momento</i>
                                            @endif
                                        </small></p>
                                        <p>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                <a href="#" data-target="#avaliar-prestador" data-toggle="modal" data-id="{{ $pedido->id }}"> <i class="fa fa-thumbs-o-up"></i> Avaliar Prestador </a>
                                            </div>
                                            @if(count($pedido->interessados) >0)
                                                <div class="col-sm-3">
                                                    <a href="{{ url('client/pedido/show',$pedido->id) }}"> <i class="fa fa-comment-o"></i> Mensagens </a>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                        ...
                        @else
                            <div class="text-center">
                                ...
                                <h4>Você ainda não possui pedidos.</h4><br>
                                <a href="{{ url('/client/pedido') }}" class="btn btn-success">Fazer meu primeiro pedido</a>
                            </div>
                        @endif
                    </div> <!--end col-12 -->
                </div>
    ...
    <div class="modal fade" id="avaliar-prestador" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="overflow: visible;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <div class="modal-body">
                    <form>
                        <label>Qual prestador deseja avaliar?</label>
