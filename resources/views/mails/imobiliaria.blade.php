...
<head>
    ...
    <title>Conheça o Mestre Obra</title>
                                    ...
                                    <table width="100" align="left" border="0" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="left" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 14px;color: #666666" st-content="viewonline" class="mobile-hide">
                                                <a href="{{ env('APP_URL') }}/email/imobiliarias" style="text-decoration: none; color: #666666">Ver Online </a>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                    <table width="100" align="right" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                        ...
                                        <tr>
                                            <td width="30" height="30" align="right">
                                                <div class="imgpop">
                                                    <a target="_blank" href="https://www.facebook.com/mestreobra.com.br/">
                                                        <img src="{{ env('APP_URL') }}/assets/images/email/facebook.png" alt="" border="0" width="30" height="30" style="display:block; border:none; outline:none; text-decoration:none;">
                                                    </a>
                                                </div>
                                            </td>
                                            ...
                                            <td width="169" height="45" align="center">
                                                <div class="imgpop">
                                                    <a target="_blank" href="{{ env('APP_URL') }}">
                                                        <img src="{{ env('APP_URL') }}/assets/images/email/logoMO.png" alt="" border="0" width="169" height="45" style="display:block; border:none; outline:none; text-decoration:none;">
                                                    </a>
                                                </div>
                                            </td>
                                        </tr>
                                    ...
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 30px; color: #333333; text-align:center; line-height: 30px;" st-title="fulltext-heading">
                                                Gere valor para seu cliente e ganhe mais
                                            </td>
                                        </tr>
                                        <!-- End of Title -->
                                        <!-- spacing -->
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #666666; text-align:center; line-height: 30px;" st-content="fulltext-content">
                                                Durante as locações, facilite a vida do seu inquilino oferecendo ajuda na hora de fazer manutenções e reparos. E após as vendas, ajude seu cliente a deixar o imóvel da maneira como ele sempre sonhou! Faça isso com a ajuda do Mestre Obra!
                                            </td>
                                        </tr>
                                        <!-- End of content -->
                                        </tbody>
...
<table width="100%" bgcolor="#ffffff" cellpadding="0" cellspacing="0" border="0" id="backgroundTable">
    ...
    <!-- Title -->
    <tr>
        <td style="font-family: Helvetica, arial, sans-serif; font-size: 20px; color: #333333; text-align:center; line-height: 30px;" st-title="fulltext-title">
            Basta descrever o que precisa e aguardar os contatos
        </td>
    </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="186" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                        ...
                                        <tr>
                                            <td width="100%" align="center" class="devicewidth">
                                                <img src="http://www.mestreobra.com.br/assets/images/email/icon01.png" alt="" border="0" width="50" height="50" style="display:block; border:none; outline:none; text-decoration:none;">
                                            </td>
                                        </tr>
                                        <!-- end of image2 -->
                                        <tr>
                                                ...
                                                <table width="186" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner">
                                                    ...
                                                    <tr>
                                                        <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #889098; text-align:center; line-height: 24px;" st-content="3col-content1">
                                                            Encontre diversos profissionais e empresas da construção civil
                                                        </td>
                                                    </tr>
                                                    <!-- end of content2 -->
                                                    <!-- Spacing -->
                                    ...
                                    <table width="186" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                        ...
                                        <tr>
                                            <td width="100%" align="center" class="devicewidth">
                                                <img src="{{ env('APP_URL') }}/assets/images/email/icon02.png" alt="" border="0" width="50" height="50" style="display:block; border:none; outline:none; text-decoration:none;">
                                            </td>
                                        </tr>
                                        <!-- end of image2 -->
                                        <tr>
                                                ...
                                                <table width="186" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner">
                                                    ...
                                                    <tr>
                                                        <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #889098; text-align:center; line-height: 24px;" st-content="3col-content2">
                                                            Receba orçamentos e propostas de modo rápido, fácil e gratuito
                                                        </td>
                                                    </tr>
                                                    <!-- end of content2 -->
                                                    <!-- Spacing -->
                                    ...
                                    <table width="186" align="right" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                        ...
                                        <tr>
                                            <td width="100%" align="center" class="devicewidth">
                                                <img src="{{ env('APP_URL') }}/assets/images/email/icon03.png" alt="" border="0" width="50" height="50" style="display:block; border:none; outline:none; text-decoration:none;">
                                            </td>
                                        </tr>
                                        <!-- end of image3 -->
                                        <tr>
                                                ...
                                                <table width="186" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidthinner">
                                                    ...
                                                    <tr>
                                                        <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #889098; text-align:center; line-height: 24px;" st-content="3col-content3">
                                                            Analise, negocie e indique o melhor profissional atender o seu cliente
                                                        </td>
                                                    </tr>
                                                    <!-- end of content -->
                                                    <!-- Spacing -->
                                    ...
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 30px; color: #333333; text-align:center; line-height: 30px;" st-title="fulltext-title">
                                                <a href="{{ env('APP_URL') }}">www.mestreobra.com.br</a>
                                            </td>
                                        </tr>
                                        <!-- End of Title -->
                                        <!-- spacing -->
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 16px; color: #666666; text-align:center; line-height: 30px;" st-content="fulltext-content">
                                                A melhor solução para o sua obra.
                                            </td>
                                        </tr>
                                        <!-- End of content -->
                                        </tbody>
