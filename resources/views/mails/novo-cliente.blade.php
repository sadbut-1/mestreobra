                            ...
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                    ...
                                    <p style="{{ $style['paragraph'] }}">
                                        Obrigado por utilizar o Mestre Obra!<br>
                                    </p>
                                    <p style="{{ $style['paragraph-sub'] }}">
                                        - Seu pedido foi enviado para os profissionais que realizam o serviço solicitado e logo eles entrarão em contato.<br>
                                        - Você pode acompanhar também a situação do seu pedido através da nossa plataforma clicando no link abaixo:
                                    </p>
