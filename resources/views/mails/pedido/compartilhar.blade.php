                        ...
                        <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                    <!-- Greeting -->
                                    <h1 style="{{ $style['header-1'] }}">Olá!</h1>

                                    <!-- Intro -->
                                    <p style="{{ $style['paragraph'] }}">
                                        Nosso cliente {{ $nome }} fez uma solicitação de serviço e deseja compartilhar os detalhes com você.<br>
                                    </p>
                                    <p style="{{ $style['paragraph-sub'] }}">
                                        <i>{{ $detalhes }}</i>
                                    </p>
                                    <p style="{{ $style['paragraph-sub'] }}">
                                        Para verificar todos os detalhes, basta acessar nossa plataforma clicando no link abaixo.
                                    </p>
                                    ...
                                    <table style="{{ $style['body_action'] }}" align="center" width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="center">
                                                ...
                                                <a href="{{ env('APP_URL') }}/pedido/compartilhar/{{ $hash }}"
